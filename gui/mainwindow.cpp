...
void MainWindow::toggleActions(bool b)
{
    ...
    actionStartPointLine->setVisible(b * isLineIconClicked);
    actionMiddlePointLine->setVisible(b * isLineIconClicked);
    actionEndPointLine->setVisible(b * isLineIconClicked);
    ...
    actionCenterPointCircle->setVisible(b * isCircleIconClicked);
    actionTwoPointCircle->setVisible(b * isCircleIconClicked);
...
void MainWindow::newFile()
{
    ...
    connect(actionLine, SIGNAL(triggered()),
            view, SLOT(drawLine()));
    connect(actionStartPointLine, SIGNAL(triggered()),
            view, SLOT(drawStartPointLine()));
    connect(actionMiddlePointLine, SIGNAL(triggered()),
            view, SLOT(drawMiddlePointLine()));
    connect(actionEndPointLine, SIGNAL(triggered()),
            view, SLOT(drawEndPointLine()));
    ...
    connect(actionCenterPointCircle, SIGNAL(triggered()),
            view, SLOT(drawCenterPointCircle()));
    connect(actionTwoPointCircle, SIGNAL(triggered()),
            view, SLOT(drawTwoPointCircle()));
